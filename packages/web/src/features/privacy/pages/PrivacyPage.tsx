...
import { ArrowRight, Eye, Hash, Server, Shield } from 'lucide-react';
import {
	Breadcrumb,
	BreadcrumbItem,
	BreadcrumbLink,
			...
			<div className="space-y-4">
				...
				<Card>
					<CardHeader>
						...
						<CardDescription>What we collect and how your data is handled</CardDescription>
					</CardHeader>
					<CardContent className="space-y-8">
						{/* What We Collect */}
						<section>
							<h3 className="text-sm font-medium mb-1">What We Collect</h3>

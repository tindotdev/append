...
import { ArrowRight, Download, Eye, Hash, Server, Shield } from 'lucide-react';
	...
	return (
		<div className="@container/main w-full max-w-3xl">
			...
			<div className="mb-6">
				...
				<p className="mt-2 text-sm text-muted-foreground leading-relaxed">What we collect and how your data is handled.</p>
			</div>

			<div className="space-y-16">
				{/* What We Collect */}
				<section>
					<h2 className="text-lg font-semibold tracking-tight mb-1">What We Collect</h2>
					<p className="text-sm text-muted-foreground leading-relaxed mb-6">
						Append collects the minimum data needed to power your learning dashboard.
					</p>

					<div className="grid grid-cols-1 gap-6 @lg/main:grid-cols-2 mb-8">
					...
					<div>
						...
						<ul className="grid grid-cols-1 gap-2 @lg/main:grid-cols-2">
				...
				<section>
					<h2 className="text-lg font-semibold tracking-tight mb-1">URL Normalization & Hashing</h2>
				...
				<section>
					<h2 className="text-lg font-semibold tracking-tight mb-1">How We Estimate Learning Time</h2>
					<p className="text-sm text-muted-foreground leading-relaxed mb-6">
				...
				<section>
					<h2 className="text-lg font-semibold tracking-tight mb-1">Your Data, Your Control</h2>
					<p className="text-sm text-muted-foreground leading-relaxed mb-6">
						All telemetry events are stored append-only and never modified or deleted without your explicit action.
					</p>

					<Link to="/export" className="block rounded-lg border border-border/60 bg-accent/30 p-5 transition-colors hover:bg-accent/40">
						<div className="flex items-center justify-between">
							<div className="flex-1">
								<p className="text-sm font-semibold text-foreground">Raw Events Export</p>
								<p className="text-sm text-muted-foreground leading-relaxed mt-1">Download your complete event history as NDJSON</p>
							</div>

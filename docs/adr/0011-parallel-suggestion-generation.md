...
Suggestion generation for batch terms is slow. Processing 20 terms sequentially takes ~100 seconds (5 seconds per LLM call). Users reported this as a high-impact issue (#3 in ROADMAP.md).
